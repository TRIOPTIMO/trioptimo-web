  ...
  return (
    <Box sx={{ px: 3, py: 1 }}>
      <Stack
        ...
        aria-label={t("footer.contact.aria")}
      >
        <Typography>{t("footer.contact.title")}</Typography>
        ...
        <Stack direction="row" spacing={1.5} alignItems="center">
          <IconButton
            ...
            size="small"
            aria-label={t("footer.contact.linkedinAria")}
            title={t("footer.contact.linkedinTitle")}
            sx={{
          ...
          <IconButton
            ...
            rel="noreferrer noopener"
            size="small"
            aria-label={t("footer.contact.instagramAria")}
            title={t("footer.contact.instagramTitle")}
            sx={{
              bgcolor: "background.paper",
              borderRadius: "999px",
              boxShadow: 0,
